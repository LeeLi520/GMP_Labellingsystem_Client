...
public class QA_ReleaseForSponsor extends Label {
	
	private String itemCode;
	private String itemName;
	private String batch;
	
	public QA_ReleaseForSponsor(String itemCode, String itemName, String batch) {
		super();
	...
	public String toString() {
		...
		String log = "{"
				+ "{labeltype:\"QA_ReleaseForSponsor\"},"
				+ "{itemCode:\""+itemCode+"\"},"
				+ "{itemName:\""+itemName+"\"},"
				+ "{batch:\""+batch+"\"},"
	...
	public String printZPLFormat() {
		 String s = "^XA" +
	       		 "^FO238,20"+ 
		             ...
		             "^FO118,55"+ 
		             "^A0N,28,38"+ 
		             "^FDPRODUCT RELEASE TO THE SPONSOR^FS"+
		             "^FO50,100"+
