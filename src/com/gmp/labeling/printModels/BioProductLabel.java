...
public class BioProductLabel extends Label {
	...
	public BioProductLabel(String productName, String itemCode, String batch, String quantity, String cartonNo,
			String useByFormat,String useBy, String packedBy, String temperature, String btmNoticeInfo) {
		super();
...
//    	 		+ "^FO255,248^BY2"                               // Marketing batch + Used by date barcode
//    	 		+ "^BCN,65,N,N,Y"
//    	 		+ "^FD"+useBy+" "+batch+"^FS"
//    	 		+ "^FO420,318,0"
//    	 		+ "^A@N,30,28,E:TAH005.TTF" 
