...
public class HW_DamagedLabel extends Label {
	...
	public HW_DamagedLabel(String itemCode, String itemName, String ginNumber, String grossWeight, String netWeight,
			String unit, String preparedDate, User user) {
		super();
