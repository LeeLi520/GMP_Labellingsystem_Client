...
public class QA_ApprovedForSupply extends Label {
	
	private String itemCode;
	private String itemName;
	private String batch;
	
	public QA_ApprovedForSupply(String itemCode, String itemName, String batch) {
		super();
	...
	public String toString() {
		...
		String log = "{"
				+ "{labeltype:\"QA_ApprovedForSupply\"},"
				+ "{itemCode:\""+itemCode+"\"},"
				+ "{itemName:\""+itemName+"\"},"
				+ "{batch:\""+batch+"\"},"
	...
	public String printZPLFormat() {
        String s = "^XA" +
        		   ...
        		   "^FO158,55"+ 
        		   "^A0N,28,38"+ 
        		   "^FDPRODUCT RELEASE FOR SUPPLY^FS"+
        		   "^FO50,100"+
