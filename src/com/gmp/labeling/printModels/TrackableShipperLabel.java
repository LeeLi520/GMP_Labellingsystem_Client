...
public class TrackableShipperLabel extends Label {
	...
	public TrackableShipperLabel(String companyName, String productName, String itemCode, String batch, String quantity,
			String cartonNo, String usebyFormat, String useBy, String packedBy, String temperature, String regNo, String btmNoticeInfo) {
		super();
	...
	public String printZPLFormat() {
		...
		int dots = (int)((1.0 - total)*598.0/2.0);
...
//		
// First template		
// 	 		int cartonNumber = Integer.valueOf(cartonNo);
// 	 		String fctn = String.format("%05d", cartonNumber);
// 	 		
// 	 		s += "^FO30,260,0"
// 		        + "^A@N,36,25,E:TAH005.TTF"
// 	    	 	+ "^FDTracking No:^FS"
...
// Second template
 	 		int cartonNumber = Integer.valueOf(cartonNo);
 	 		String fctn = String.format("%05d", cartonNumber);
 			String trackableNumber;
 			if(batch.length()==5) {
 				trackableNumber = "G"+ batch + fctn;
 			}else {
 				trackableNumber = batch + fctn;
 			}
	         s += "^FO30,260,0"
	 	            + "^A@N,36,25,E:TAH005.TTF"
	     	 		+ "^FDBatch No:^FS"
