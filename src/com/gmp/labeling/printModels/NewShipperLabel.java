...
public class NewShipperLabel extends Label {
	String companyName;
	String productName; 
	String itemCode; 
	String workOrder; 
	...
	public NewShipperLabel(String companyName, String productName, String itemCode, String workOrder, String batch,
