...
public class AssetLabelIO extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5381636437094387032L;
	...
	public AssetLabelIO(Settings settings, PrintingQueue printqueue) {
		...
		Asset_company.setModel(new DefaultComboBoxModel(new String[] {"GMP Pharmaceuticals", "Health Sharing Group", "Aunew","Sphere Healthcare"}));
		...
		JButton Asset_btn_settings = new JButton("Settings");
		Asset_btn_settings.addActionListener(new ActionListener() {
		...
		Asset_btn_settings.setBounds(30, 390, 110, 20);
		contentPane.add(Asset_btn_settings);
		
		JButton Asset_btn_print = new JButton("Print");
		Asset_btn_print.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				if( dataValidation(Asset_assetNumber.getText(), Asset_department.getText(), Asset_poNumber.getText(), Asset_deviceName.getText(),
					...
					int i = 0;
					while(i<printNumber) {
						printqueue.addLabelToQueue(new AssetLabel(Asset_company.getSelectedItem().toString(), Asset_assetNumber.getText(), Asset_deviceName.getText(), Asset_department.getText(), 
		...
		JButton Asset_btn_back = new JButton("Back");
		...
		Asset_btn_back.setBounds(330, 390, 110, 20);
		...
		Asset_copyright_company.setBounds(180, 430, 280, 20);
		...
		Asset_btn_developer.setBounds(280, 415, 170, 20);
		contentPane.add(Asset_btn_developer);
		
		
		Asset_btn_print.setBounds(180, 390, 110, 20);
		contentPane.add(Asset_btn_print);
